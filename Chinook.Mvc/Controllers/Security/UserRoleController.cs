...
namespace EasyLOB.Security.Mvc
{
    public class UserRoleController : BaseControllerSCRUDPersistence<UserRole>
    {
        ...
        public ActionResult Search(string masterControllerAction = null, string masterRoleId = null, string masterUserId = null)
        {
            ...
            return PartialView("_UserRoleCollection", userRoleCollectionModel);
        }
        ...
        public ActionResult Create(UserRoleItemModel userRoleItemModel)
        {
            ...
            userRoleItemModel.IsSecurityOperations = IsSecurityOperations;
