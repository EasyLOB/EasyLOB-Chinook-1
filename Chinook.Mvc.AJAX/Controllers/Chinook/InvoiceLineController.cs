...
namespace Chinook.Mvc
{
    public class InvoiceLineController : BaseControllerSCRUDApplication<InvoiceLineDTO, InvoiceLine>
    {
        ...
        public ActionResult Search(string masterUrl = null, string masterControllerAction = null, int? masterInvoiceId = null, int? masterTrackId = null)
        {
        ...
        public ActionResult Create(int? masterInvoiceId = null, int? masterTrackId = null)
        {
            ...
            return PartialView(invoiceLineItemModel);
        }
